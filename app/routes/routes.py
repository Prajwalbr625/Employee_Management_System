...
@app_routes.route('/employees', methods=['POST'])
def add_employee():
...
#Employee GET method
@app_routes.route('/employees', methods=['GET']) 
...
@app_routes.route('/employees/<employee_id>', methods=['DELETE'])
...
@app_routes.route('/list-employees', methods=['GET'])
def list_employees():
...
@app_routes.route('/departments', methods=['POST'])
def add_department():
        data = request.get_json()
...
@app_routes.route('/departments', methods=['GET'])
...
@app_routes.route('/departments/<departmentID>', methods=['PUT'])
...
@app_routes.route('/departments/<departmentID>', methods=['DELETE'])
...
@app_routes.route('/list-departments', methods=['GET'])
...
@app_routes.route('/report/departmentList', methods=['POST'])
...
@app_routes.route('/report/employeeSalary', methods=['POST'])
